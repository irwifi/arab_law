...
<head>
    <title>Fujairah laws issued by the local governament from 1971 to 2012</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="Fujairah laws and legislation issued by the local governament from 1971 to 2012." />
	<meta name="keywords" content="fujairah laws, fujairah laws in english, fujairah laws online, translated laws of fujairah" />
...
<div id="header">
    <div class="header_inner">
		<a href="./index.php" title="Back to home" class="logo">Fujairah Laws</a>
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/banner_consulting.jpg" width="980" height="218" alt="Fujairah Laws" title = "Fujairah Laws" />
            </div>        
            ...
            <h1>Fujairah Laws</h1>
           <p>
           Fujairah Laws issued by the Local Governament of Fujairah United Arab Emirates from 1971 to 2011. All Fujairah Laws have been translated into English and available online for purchase on this page. you may order online and get a instant download link from us.  </p>


<?
//include("common.inc");
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%Fujairah%' ORDER BY law_title ASC";
...
{
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%Fujairah%' ORDER BY law_title ASC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@arablawsworld.com");
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='fujairah-local-laws.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
