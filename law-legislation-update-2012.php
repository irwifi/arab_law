...
<head>
    <title>Law Legislation Update 2012</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="We are adding new legislations and law update of 2012 after every hour in our online database to provide quality services to our clients from around the world" />
	<meta name="keywords" content="uae law update 2012, qatar law update 2012, bahrain law update 2012, qatar uae bahrain legislation update" />
...
<div id="header">
    <div class="header_inner">
        ...
        <div id="section">        
            ...
            <h1>Law Legislation Update 2012</h1>
			<p><a href = "./qatar-law-legislation-update-2012.php">Qatar Law Legislation Update 2012</a> | <a href = "./bahrain-law-legislation-update-2012.php">Bahrain Law Legislation Update 2012</a> | <a href = "./uae-law-legislation-update-2012.php">UAE Law Legislation Update 2012</a></p>
            <p>Arab Laws Online provides up-to-date legislations and law updates of 2012 with federal laws, decrees, amendments, resolutions and decisions of all GCC and Middle East countries including UAE, Qatar, Bahrain, kuwait, Oman and Saudi Arabia. We are adding new legislations and laws of 2012 after every hour in our online database to provide quality services to our clients from around the world.</p> <p>However if you are not able to find your required legislation update of 2012 in our database, please let us know we will provide you translation on demand services and our team would be more than happy to assist you.</p>
           
<?
//include("common.inc");
$query = "SELECT law_id, law_title, law_desc, law_price, law_cat FROM en_laws WHERE law_publish = 'Y' AND law_clicks=2012 ORDER BY law_id DESC";
...
{
$query = "SELECT law_id, law_title, law_desc, law_price, law_cat FROM en_laws WHERE law_publish = 'Y' AND law_clicks=2012 ORDER BY law_id DESC LIMIT $offset, $rec_per_page";
}
...
?>
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='law-legislation-update-2012.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
