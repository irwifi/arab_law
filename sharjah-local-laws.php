...
<head>
    <title>Sharjah Laws Emiri Decrees Decisions Ministerial and Executive Resolutions</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="Sharjah laws issued by the local governament including decrees decisions and executive resolutions." />
	<meta name="keywords" content="sharjah laws, sharjah laws in english, sharjah laws online, translated sharjah laws" />
...
<div id="header">
    <div class="header_inner">
		<a href="./index.php" title="Back to home" class="logo">Sharjah Laws</a>
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/banner_consulting.jpg" width="980" height="218" alt="Sharjah Laws" title = "Sharjah Laws" />
            </div>        
            ...
            <h1>Sharjah Laws</h1>
           <p>
           Sharjah laws issued by the local governament of sharjah from 1971 to 2012. Sharjah legislation and laws including emiri decrees,decisions, ministerial resolutions and administrative regulations have been translated into english and available online for purchase on this page. You may get instant download link from us after successful purchase.  </p>


<?
//include("common.inc");
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%Sharjah%' ORDER BY law_title ASC";
...
{
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%Sharjah%' ORDER BY law_title ASC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@arablawsworld.com");
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='sharjah-local-laws.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
