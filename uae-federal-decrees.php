...
<head>
    <title>UAE federal decrees | federal decrees of uae</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="UAE federal decrees issued by the federal cabinet of united arab emirates, we obtain these decrees and translate into english for our global clients." />
	<meta name="keywords" content="uae federal decrees, federal decrees of uae, uae federal decree" />
...
<div id="header">
    <div class="header_inner">
		<a href="./index.php" title="Back to home" class="logo">UAE Federal Decrees</a>
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/banner_consulting.jpg" width="980" height="218" alt="UAE Federal Decrees" title = "UAE Federal Decrees" />
            </div>        
            ...
            <ul class="breadcrumb">
            	...
            	<li><a href="./index.php" title = "arab laws online">Arab Laws Online</a></li>
                
                <li>/<a href="./uae-laws.php" title = "uae laws and legislations">UAE Laws and Legislations</a></li>
                
                <li><a href="./uae-federal-decrees.php" title = "uae federal decrees">UAE Federal Decrees</a></li>
            
            </ul>
            
            <h1>UAE Federal Decrees</h1>
			<h2>UAE Federal Decree</h2>
           <p>
           UAE Federal Decrees issued by the Governament of United Arab Emirates from 1971 to 2011. All Federal Decrees have been translated into English and available online for purchase on this page. you may order online and get a instant download link from us.  </p>


<?
//include("common.inc");
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE 'UAE Federal Decree%' AND law_publish = 'Y' ORDER BY law_id DESC";
...
{
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE 'UAE Federal Decree%' AND law_publish = 'Y' ORDER BY law_id DESC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@arablawsworld.com");
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='uae-federal-decrees.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
