           ...
           <? if($num_rec>0){ ?>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="100%" id="AutoNumber1" height="190">
              ...
              <tr>
                ...
                <p style="text-align: left"><span style="font-weight: 700">
                <a href = "./law_info.php?law_id=<? print("$row[cart_product_id]"); ?>"><? print("$row[cart_product_name]"); ?></a></span></td>
                  ...
                  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="80%" id="AutoNumber2">
                    ...
                    <tr>
                      ...
                      <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="100%" id="AutoNumber3">
                        <tr>
                          <td width="100%">
<div align = "center"><a href = "javascript:history.go(-2)"><img border="0" src="images/buttons/btn_continue_shopping.png" alt = "Continue Shopping" title = "Continue Shopping" width="203" height="30" /></a> &nbsp;&nbsp;&nbsp;

<?php
$meta = unserialize(file_get_contents('http://www.geoplugin.net/php.gp?ip='.$_SERVER['REMOTE_ADDR']));
if($meta['geoplugin_countryCode']=='US'){
?>
<form name = "frm2checkout" method = "post" action = "checkout_paypal.php">
<?php
}else{
?>
<form name = "frm2checkout" method = "post" action = "checkout-paypal.php">
<?php
}
?>
<input type = "image" border="0" src="images/buttons/btn_checkout.png" alt = "Checkout with Credit Cards" width="203" height="30" />
...
<input type = "hidden" name = "tot" value = "<? print($tot); ?>">
                        ...
                        <tr>
                          <td width="100%"><img src="./images/icons/payment_methods.png" border="0" alt="Make secure payment" title="Make secure payment" /></td>
                        </tr>
                        <tr>
                          <td width="100%">&nbsp;</td>
                        </tr>
			...
			<br />
			<!-- <br /><p>By clicking on "Checkout" button above, you will be redirected to our secure payment page, we will keep your email and personal information secure to send you instant download link, however we will not share your personal information or email to any company or individual.</p> -->
			<br />
