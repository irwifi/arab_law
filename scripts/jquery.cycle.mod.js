 ...
 *  
 *  edited by Jim to allow a default image (slide) that is displayed at start, and when no button is hovered
 */
(function($) {
...
function buildPager(els, opts) {
    ...
    $.each(els, function(i,o) {
		...
		$a.bind('mouseover',function() {
			// cancel the mouseout timer because the mouseout was into a mouseover on another button
			if (out_timer)
			{
