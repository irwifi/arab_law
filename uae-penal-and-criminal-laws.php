...
<head>
    <title>UAE Penal and Criminal Laws | UAE Penal and Criminal Laws in English | UAE Penal and Criminal Laws Online</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="Laws concerning the Judicial Cooperation in Civil and Commercial matters in the United Arab Emirates" />
	<meta name="keywords" content="uae penal and criminal laws, uae penal and criminal laws in english, uae penal and criminal laws online, translated penal and criminal laws" />
...
<div id="header">
    <div class="header_inner">
		<a href="./index.php" title="Back to home" class="logo">UAE Penal and Criminal Laws</a>
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/banner_consulting.jpg" width="980" height="218" alt="UAE Penal and Criminal Laws" title = "UAE Penal and Criminal Laws" />
            </div>        
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">UAE Penal and Criminal Laws</a></li>
            
            </ul>
            
            <h1>UAE Penal and Criminal Laws</h1>
           <p>
           UAE Penal and Criminal Laws issued by the Governament of United Arab Emirates from 1971 to 2011. All Penal and Criminal Laws have been translated into English and available online for purchase on this page. you may order online and get a instant download link from us.  </p>


<?
//include("common.inc");
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE%criminal%' OR law_desc LIKE '%UAE%criminal%' ORDER BY law_title ASC";
...
{
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE%criminal%' OR law_desc LIKE '%UAE%criminal%' ORDER BY law_title ASC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@arablawsworld.com");
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='uae-penal-and-criminal-laws.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
