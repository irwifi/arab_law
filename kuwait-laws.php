...
<head>
    <title>Kuwait laws and legislation in english with cabinet and ministerial resolutions regulations and constitutional amendments. </title>
    
    
<!-- META TAGS -->

	<meta name="description" content="Kuwait laws are decided by a combination of the monarchy and parliament by the governament and we translate these into english language." />
	<meta name="keywords" content="kuwait laws, kuwait legislation, kuwait lawsuits, kuwait laws in english" />
...
<div id="header">
    <div class="header_inner">
		<a href="./index.php" title="Back to home" class="logo">Kuwait Laws</a>
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/kuwait-laws.jpg" width="980" height="218" alt="Kuwait Laws" title = "Kuwait Laws" />
            </div>        
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="./kuwait-laws.php">Kuwait Laws</a></li>
            
            </ul>
            
            <h1>Kuwait Laws</h1>
           <p>
           As a constitutional monarchy, Kuwait laws and kuwaiti legislation are decided by a combination of the monarchy and parliament. Political parties are illegal, though the parliament is partially elected.  </p>


<?
//include("common.inc");
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_cat = 57 AND law_publish = 'Y' ORDER BY law_id DESC";
...
{
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_cat = 57 AND law_publish = 'Y' ORDER BY law_id DESC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@arablawsworld.com");
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='kuwait-laws.php?catid=57&cat=Kuwait Laws&page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>

<p>As one might imagine, much of the power in the country comes from those who control the oil and resulting revenues. The wealthiest individuals have quite a bit of say in any changes to Kuwait laws. These people are given top posts in the executive cabinet and parliament. However, their position is never secure as the Prime Minister is empowered to remove them from their position as he pleases. It doesn't stop there though, as the ruling monarch, called an Amir, can remove the Prime Minister as he pleases, even though this post is often filled by the Crown Prince.</p>

<p>A popular, yet not incredibly efficient Kuwait law is one that guarantees every Kuwaiti a job. This results in many people being assigned to tasks that could be handled by one person. The result is that this Kuwait law leaves the government as the largest employer in the country. </p>
