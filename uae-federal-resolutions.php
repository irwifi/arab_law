...
<head>
    <title>UAE Federal Resolutions | UAE Federal Resolutions in English | UAE Federal Resolutions Online</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="UAE Federal Resolutions issued by the Governament of United Arab Emirates from 1971 to 2011. All Federal Resolutions have been translated into English and available online for purchase on this page." />
	<meta name="keywords" content="uae federal resolutions, uae federal resolutions in english, uae federal resolutions online, translated uae federal resolutions" />
...
<div id="header">
    <div class="header_inner">
		<a href="./index.php" title="Back to home" class="logo">UAE Federal Resolutions</a>
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/banner_consulting.jpg" width="980" height="218" alt="UAE Federal Resolutions" title = "UAE Federal Resolutions" />
            </div>        
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">UAE Federal Resolutions</a></li>
            
            </ul>
            
            <h1>UAE Federal Resolutions</h1>
           <p>
           UAE Federal Resolutions issued by the Governament of United Arab Emirates from 1971 to 2011. All Federal Resolutions have been translated into English and available online for purchase on this page. you may order online and get a instant download link from us.  </p>


<?
//include("common.inc");
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE%Resolution%' AND law_publish = 'Y' ORDER BY law_id ASC";
...
{
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE%Resolution%' AND law_publish = 'Y' ORDER BY law_id ASC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@arablawsworld.com");
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='uae-federal-resolutions.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
