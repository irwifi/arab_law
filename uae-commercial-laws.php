...
<head>
    <title>UAE commercial laws</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="concerning the UAE Commercial Laws in the country including 7 Emirates" />
	<meta name="keywords" content="uae commercial laws, uae commercial laws in english, uae commercial laws online, translated commercial laws" />
...
<div id="header">
    <div class="header_inner">
		<a href="./index.php" title="Back to home" class="logo">UAE Commercial Laws</a>
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/banner_consulting.jpg" width="980" height="218" alt="UAE Commercial Laws" title = "UAE Commercial Laws" />
            </div>        
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">UAE Commercial Laws</a></li>
            
            </ul>
            
            <h1>UAE Commercial Laws</h1>
           <p>
           UAE Commercial Laws issued by the Governament of United Arab Emirates from 1971 to 2011. All Commercial Laws have been translated into English and available online for purchase on this page. you may order online and get a instant download link from us.  </p>


<?
//include("common.inc");
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE% Commercial%' OR law_desc LIKE '%UAE% Commercial%' ORDER BY law_title ASC";
...
{
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE% Commercial%' OR law_desc LIKE '%UAE% Commercial%' ORDER BY law_title ASC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@arablawsworld.com");
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='uae-commercial-laws.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
