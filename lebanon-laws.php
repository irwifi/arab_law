...
<head>
    <title>Lebanon Laws and Legislative Decree in English Language</title>
    
    
<!-- META TAGS -->
	<meta name="description" content="Lebanon is not controlled by an authorization ruler, unlike most Arab states that are being ruled by the same person or a dynasty like a father to son combination for decades." />
	<meta name="keywords" content="lebanon laws, lebanon laws and regulations, lebanon lawsuits, lebanon laws info, lebanon divorce laws, lebanon laws online" />
...
<div id="header">
    <div class="header_inner">
		<a href="./index.php" title="Back to home" class="logo">Lebanon Laws</a>
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/lebanon-laws.jpg" width="980" height="218" alt="Lebanon Laws" title = "Lebanon Laws" />
            </div>        
...
{
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_cat = 69 AND law_publish = 'Y' ORDER BY law_id DESC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@arablawsworld.com");
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='lebanon-laws.php?catid=69&cat=Lebanon Laws&page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
<p>According to this confessional system, each citizen must choose a sect before he or she can get their rights as a citizen. Religious authorities control all family laws such as birth, marriage, death and inheritance. Because it is the religious courts who has jurisdiction on family laws, civil marriage doesn’t exist in Lebanon.</p>

<p>According to the majority of religious laws, the father is granted with child custody and the child is automatically registered in the village of the father. The parents, under the Shiite courts, are allowed to leave their property to their daughters alone, while in Sunni courts, it is required that at least some of the assets go to the closest male relative. There are also some sects that give men lesser penalty for harming their female relatives if they did it as a means of protecting their “family honor”. Lebanon laws also don’t recognize rape within marriage as a crime. </p>
