...
<head>
    <title>UAE Presidential Resolutions | UAE Presidential Resolutions in English | UAE Presidential Resolutions Online</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="UAE Presidential Resolutions issued by the Governament of United Arab Emirates from 1971 to 2011. All Presidential Resolutions have been translated into English and available online for purchase on this page." />
	<meta name="keywords" content="uae presidential resolutions, uae presidential resolutions in english, uae presidential resolutions online, translated uae presidential resolutions" />
...
<div id="header">
    <div class="header_inner">
		<a href="./index.php" title="Back to home" class="logo">UAE Presidential Resolutions</a>
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/banner_consulting.jpg" width="980" height="218" alt="UAE Presidential Resolutions" title = "UAE Presidential Resolutions" />
            </div>        
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">UAE Presidential Resolutions</a></li>
            
            </ul>
            
            <h1>UAE Presidential Resolutions</h1>
           <p>
           UAE Presidential Resolutions issued by the Governament of United Arab Emirates from 1971 to 2011. All Presidential Resolutions have been translated into English and available online for purchase on this page. you may order online and get a instant download link from us.  </p>


<?
//include("common.inc");
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE% Presidential Resolution%' AND law_publish = 'Y' ORDER BY law_id ASC";
...
{
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE% Presidential Resolution%' AND law_publish = 'Y' ORDER BY law_id ASC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@arablawsworld.com");
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='uae-presidential-resolutions.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
