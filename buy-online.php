...
<head>
    <title>Buy and order online english translation of middleeast legislation</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="Arab laws Online being one of the biggest collection of legislation for arab countries now offering online order service." />
...
<div id="header">
    <div class="header_inner">
        ...
        <div id="section">        
            ...
            <h1>Buy Online: Middle East Laws</h1>
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='buy-online.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
