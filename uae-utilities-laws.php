...
<head>
    <title>UAE Utilities Laws | UAE Utilities Laws in English | UAE Utilities Laws Online</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="Laws concerning utilities in the United Arab Emirates and its seven emirates" />
	<meta name="keywords" content="uae utilities laws, uae utilities laws in english, uae utilities laws online, translated utilities laws" />
...
<div id="header">
    <div class="header_inner">
		<a href="./index.php" title="Back to home" class="logo">UAE Utilities Laws</a>
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/banner_consulting.jpg" width="980" height="218" alt="UAE Utilities Laws" title = "UAE Utilities Laws" />
            </div>        
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">UAE Utilities Laws</a></li>
            
            </ul>
            
            <h1>UAE Utilities Laws</h1>
           <p>
           UAE Utilities Laws issued by the Governament of United Arab Emirates from 1971 to 2011. All Utilities Laws have been translated into English and available online for purchase on this page. you may order online and get a instant download link from us.  </p>


<?
//include("common.inc");
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE% water%' OR law_desc LIKE '%UAE% water%' ORDER BY law_title ASC";
...
{
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE% water%' OR law_desc LIKE '%UAE% water%' ORDER BY law_title ASC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@arablawsworld.com");
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='uae-utilities-laws.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
