...
<head>
    <title>Comprehensive list of laws and regulations of 25 arab countries including middle east and GCC</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="We have more than 5000 translated laws and legislation of 25 arab countries including gcc middleeast and africa." />
	<meta name="keywords" content="middle east laws, gcc laws, arab laws" />
...
<div id="header">
    <div class="header_inner">
        ...
        <div id="section">        
            ...
            <h1>Arab Laws Index</h1>
           
<?
//include("common.inc");
$query = "SELECT en_laws.law_id, en_laws.law_title, en_laws.law_desc, en_laws.law_price, en_laws.law_cat, en_cats.cat FROM en_laws, en_cats WHERE en_laws.law_cat = en_cats.catid AND en_laws.law_publish = 'Y' ORDER BY en_cats.cat ASC";
...
{
$query = "SELECT en_laws.law_id, en_laws.law_title, en_laws.law_desc, en_laws.law_price, en_laws.law_cat, en_cats.cat FROM en_laws, en_cats WHERE en_laws.law_cat = en_cats.catid AND en_laws.law_publish = 'Y' ORDER BY en_cats.cat ASC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@wonderd.ae");
