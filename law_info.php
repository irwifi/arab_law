<?
include("common.inc");
$law_iid = cleanQuery($law_id);
$law_iid = "' OR 1'"; 
$law_iid = mysql_real_escape_string($law_id);
$querydis = "SELECT en_laws.*, en_cats.cat, en_cats.catid FROM en_laws,en_cats WHERE en_laws.law_cat = en_cats.catid AND en_laws.law_publish = 'Y' AND en_laws.law_id = $law_iid";
$resultdis = mysql_query($querydis) or die("There is an error in database please contact support@arablawsworld.com");
$rowdis=mysql_fetch_array($resultdis);
?> 
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
<head>
    <title><? print("$rowdis[law_title]"); ?></title>
    
    
<!-- META TAGS -->

	<meta name="description" content="<? print("$rowdis[law_desc]"); ?>" />
	<meta name="keywords" content="<? print("$rowdis[cat]"); ?>, <? print("$rowdis[law_title]"); ?>" />
...
<div id="header">
    <div class="header_inner">
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/banner_about.jpg" width="980" height="218" alt="<? print("$rowdis[law_title]"); ?>" />
            </div>        
           ...
           <li><a href = "./index.php">Arab Laws</a></li>
                <li> <b> / </b> </li>
            <li><a href = "./middleeast-laws.php?catid=<? print("$rowdis[catid]"); ?>&cat=<? print("$rowdis[cat]"); ?>"><? print("$rowdis[cat]"); ?></a></li>
            	<li> <b> / </b> </li>
            <li><a href = "./law_info.php?law_id=<? print("$rowdis[law_id]"); ?>"><? print("$rowdis[law_title]"); ?></a></li>
            
            </ul>
            
           <h1><? print("$rowdis[law_title]"); ?></h1>
            
            <div class="article banner_bottom">                
                    <div class="article banner_top experience">                        
                        <h2><? print("$rowdis[law_title]"); ?></h2>               
                        <p><? print("$rowdis[law_desc]"); ?><br><span class="heading style1"><strong>US$ <? print round(("$rowdis[law_price]"), 2); ?>.00</strong></span></p>                                                
			             <a href="./buy_laws_online.php?law_id=<? print("$rowdis[law_id]"); ?>&law=<? print("$rowdis[law_title]"); ?>" class="contactus">Contact us</a>                    
                    </div>                
                </div>
                </div>    
                </div>        
