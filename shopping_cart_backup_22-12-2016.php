                  ...
                  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="80%" id="AutoNumber2">
                    ...
                    <tr>
                      ...
                      <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="100%" id="AutoNumber3">
                        <tr>
                          <td width="100%">
<div align = "center"><a href = "javascript:history.go(-2)"><img border="0" src="images/buttons/btn_continue_shopping.png" alt = "Continue Shopping" title = "Continue Shopping" width="203" height="30" /></a> &nbsp;&nbsp;&nbsp;<form name = "frm2checkout" method = "post" action = "checkout.php"><input type = "image" border="0" src="images/buttons/btn_checkout.png" alt = "Checkout with Credit Cards" width="203" height="30" /><input type = "hidden" name = "cartid" value = "<? print($cartid); ?>"><input type = "hidden" name = "tot" value = "<? print($tot); ?>"></form></div>
</td>
                        </tr>
                        <tr>
                          <td width="100%">&nbsp;</td>
