...
<head>
    <title>UAE Insurance Laws | UAE Insurance Laws in English | UAE Insurance Laws Online</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="concerning the Executive Rules for the Application of the Provisions of Insurance Protection System to the GCC Nationals working outside their states in any other GCC state" />
	<meta name="keywords" content="uae insurance laws, uae insurance laws in english, uae insurance laws online, translated insurance laws" />
...
<div id="header">
    <div class="header_inner">
		<a href="./index.php" title="Back to home" class="logo">UAE Insurance Laws</a>
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/banner_consulting.jpg" width="980" height="218" alt="UAE Insurance Laws" title = "UAE Insurance Laws" />
            </div>        
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">UAE Insurance Laws</a></li>
            
            </ul>
            
            <h1>UAE Insurance Laws</h1>
           <p>
           UAE Insurance Laws issued by the Governament of United Arab Emirates from 1971 to 2011. All Insurance Laws have been translated into English and available online for purchase on this page. you may order online and get a instant download link from us.  </p>


<?
//include("common.inc");
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE%insurance%' OR law_desc LIKE '%UAE%insurance%' ORDER BY law_title ASC";
...
{
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE%insurance%' OR law_desc LIKE '%UAE%insurance%' ORDER BY law_title ASC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@arablawsworld.com");
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='uae-insurance-laws.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
