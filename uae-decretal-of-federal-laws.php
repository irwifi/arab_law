...
<head>
    <title>UAE Decretal of Federal Laws | UAE Decretal of Federal Laws in English | UAE Decretal of Federal Laws Online</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="UAE Decretal of Federal Laws issued by the Governament of United Arab Emirates from 1971 to 2011. All Decretal of Federal Laws have been translated into English and available online for purchase on this page." />
	<meta name="keywords" content="uae Decretal of Federal Laws, uae Decretal of Federal Laws in english, uae Decretal of Federal Laws online, translated uae Decretal of Federal Laws, uae Decretal of Federal Laws" />
...
<div id="header">
    <div class="header_inner">
		<a href="./index.php" title="Back to home" class="logo">UAE Decretal of Federal Laws</a>
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/banner_consulting.jpg" width="980" height="218" alt="UAE Decretal of Federal Laws" title = "UAE Decretal of Federal Laws" />
            </div>        
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">UAE Decretal of Federal Laws</a></li>
            
            </ul>
            
            <h1>UAE Decretal of Federal Laws</h1>
           <p>
           UAE Decretal of Federal Laws issued by the Governament of United Arab Emirates from 1971 to 2011. All Decretal of Federal Laws have been translated into English and available online for purchase on this page. you may order online and get a instant download link from us.  </p>


<?
//include("common.inc");
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE% Decretal%' AND law_publish = 'Y' ORDER BY law_id ASC";
...
{
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE% Decretal%' AND law_publish = 'Y' ORDER BY law_id ASC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@arablawsworld.com");
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='uae-decretal-of-federal-laws.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
