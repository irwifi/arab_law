...
<head>
    <title>Qatar law and legislation update 2012</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="During 2012 we have added almost 75 qatar legislations and laws updated including decrees, emiri decrees, resolutions and decisions." />
	<meta name="keywords" content="qatar law update 2012, qatar legislation update 2012, qatar laws 2012, qatar legislations 2012" />
...
<div id="header">
    <div class="header_inner">
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/qatar-laws.jpg" width="980" height="218" alt="Qatar Law Legislation Update 2012" title = "Qatar Law Legislation Update 2012" />
            </div>        
            ...
            <h1>Qatar Law Legislation Update 2012</h1>
			<p><strong>Qatar Law Legislation Update 2012</strong> | <a href = "./bahrain-law-legislation-update-2012.php">Bahrain Law Legislation Update 2012</a> | <a href = "./uae-law-legislation-update-2012.php">UAE Law Legislation Update 2012</a></p>
            <p>We keep our online database of qatar laws and legislations up-to-date, during 2012 we have added almost 75 qatar legislations and laws including decrees, emiri decrees, resolutions and decisions.</p> <p>However if you are not able to find your required legislation update of 2012 in our database, please let us know we will provide you translation on demand services and our team would be more than happy to assist you.</p>
           
<?
//include("common.inc");
$query = "SELECT law_id, law_title, law_desc, law_price, law_cat FROM en_laws WHERE law_publish = 'Y' AND law_clicks=2012 AND law_cat=59 ORDER BY law_id DESC";
...
{
$query = "SELECT law_id, law_title, law_desc, law_price, law_cat FROM en_laws WHERE law_publish = 'Y' AND law_clicks=2012 AND law_cat=59 ORDER BY law_id DESC LIMIT $offset, $rec_per_page";
}
...
?>
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='qatar-law-legislation-update-2012.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
