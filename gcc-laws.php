...
?>            
            ...
            <div class="article banner_bottom">                
                    <div class="article banner_top experience">                        
                        ...
                        <p><? print("$row[product_s_desc]"); ?><br><span class="heading style1"><strong>US$ <? print round(("$row[product_price]"), 2); ?>.00</strong></span></p>                                                
			             <a href="./buy_laws_online.php?cat=Middle East Laws&subcat=<? print($subcat); ?>&catid=38&subcatid=<? print("$row[category_id]"); ?>&product_id=<? print("$row[product_id]"); ?>&law=<? print("$row[product_name]"); ?>" class="contactus">Contact us</a>                    
                    </div>                
                </div>
                <? } ?>
                <p align = "center">
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='gcc-laws.php?catid=$catid&cat=$cat&subcatid=$subcatid&subcat=$subcat&page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
