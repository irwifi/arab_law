<?
include("../common.inc");
$query="select en_laws.*, en_cats.cat FROM en_laws, en_cats WHERE en_laws.law_cat = en_cats.catid ORDER BY en_laws.law_id DESC";
...
{
$query = "select en_laws.*, en_cats.cat FROM en_laws, en_cats WHERE en_laws.law_cat = en_cats.catid ORDER BY en_laws.law_id DESC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@wonderd.ae");
?>
...
<head>
    <title>Control Panel | Laws Management English</title>
...
<div id="header">
            ...
            <div align="center">
              ...
              <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="98%" id="AutoNumber1">
                <tr>
                  ...
                  <font color="#0096DB"><? print($num_rec); ?>&nbsp;</font>English Laws</b></td>
                </tr>
                <tr>
                  <td width="100%">
                  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-width: 1" width="100%" id="AutoNumber2" bordercolordark="#D8DCDF" bordercolorlight="#D8DCDF">
                    ...
                    <tr>
                      ...
                      <td width="14%" style="text-align: center">
                      <font color="#3C4F5A"><span style="font-size: 80%"><a href ="edit_law_en.php?law_id=<? print("$row[law_id]"); ?>">Edit</a></span></font></td>
                    </tr>
                    <tr>
                      <td width="100%" colspan="7"><hr></td>
                    </tr>
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='laws_managment_english.php?&page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
           </p>
