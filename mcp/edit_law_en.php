<?
include("../common.inc");
$query1="SELECT en_laws.*, en_cats.cat, en_cats.catid FROM en_cats, en_laws WHERE en_laws.law_cat = en_cats.catid AND en_laws.law_id=$law_id";
...
<head>
    <title>Control Panel | English Law | Edit Law</title>
              ...
              <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="97%" id="AutoNumber1">
                ...
                <tr>
                  ...
                  <div align="center">
                    ...
                    <form id = "frmproduct" name = "frmproduct" action="go-update-law-en.php?law_id=<? print($law_id); ?>" method="post" enctype="multipart/form-data" >
                      <tr>
...
$result = mysql_query($query) or die("There is an error in database please contact support@wonderd.ae");
		...
		<? } ?>
                      ...
                      <tr>
                        ...
                        <td width="1%">&nbsp;</td>
                        <td width="84%">
                        <input name="law_sku" class="form_field" id="law_sku" value = "<? print("$row1[law_sku]"); ?>" size="70" maxlength="190" style="float: left" /></td>
                      </tr>
                      <tr>
                        <td width="15%">&nbsp;
                        </td>
                      ...
                      <tr>
                        ...
                        <td width="1%">&nbsp;</td>
                        <td width="84%">
                        <input name="law_title" class="form_field" id="law_title" value = "<? print("$row1[law_title]"); ?>" size="70" maxlength="210" style="float: left" /></td>
                      </tr>
                      <tr>
                        <td width="15%">&nbsp;</td>
                        <td width="1%">&nbsp;</td>
                      ...
                      <tr>
                        ...
                        <td width="1%">&nbsp;</td>
                        <td width="84%">
                        <!--webbot bot="Validation" i-maximum-length="750" --><textarea name="law_desc" cols=54 rows="11" class="form_field_textarea" id="law_desc"><? print("$row1[law_desc]"); ?></textarea></td>
                      </tr>
                      <tr>
                        <td width="15%">&nbsp;</td>
                        <td width="1%">&nbsp;</td>
                      ...
                      <tr>
                        ...
                        <td width="1%">&nbsp;</td>
                        <td width="84%">
                        <input name="law_price" class="form_field" id="law_price" value = "<? print("$row1[law_price]"); ?>" size="70" maxlength="8" style="float: left" /></td>
                      </tr>
                      <tr>
                        <td width="15%">&nbsp;</td>
                        <td width="1%">&nbsp;</td>
                      ...
                      <tr>
                        <td width="15%"><font color="#0096DB">
                        <span style="font-size: 85%"><b>Law Status</b></span></font></td>
                        <td width="1%">&nbsp;</td>
                        <td width="84%">
                        <select class="input-text" name="law_publish" id = "law_publish">
        ...
        <input id = "enqbutton" value="Update" type="button" onclick = "submitProduct();"/></td>
                      </tr>
                      <tr>
                        <td width="15%">&nbsp;</td>
                        <td width="1%">&nbsp;</td>
