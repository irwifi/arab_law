...
<head>
    <title>Middle East Laws | Terms and Conditions</title>
...
<div id="header">
    <div class="header_inner">
        ...
        <div class="article banner">
			<img src="./images/pics_ah/terms.jpg" width="980" height="218" alt="ABOUT US: Bridging the gap between business and technology" />                
                <div class="hub_insert">                
                	<h1>Terms</h1>                    
                    <p>Clients always have priority</p>                
                </div>
            </div>
            <div class="aside"> 
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="./contact.php">Terms and Conditions</a></li>
