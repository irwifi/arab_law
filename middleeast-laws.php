...
<head>
    <title>Middle East Laws | <? print($_GET['cat']); ?></title>
    
    
<!-- META TAGS -->

	<meta name="description" content="Buy Middle East Laws Online" />
	<meta name="keywords" content="middle east laws, uae laws, dubai laws, gcc laws" />
    ...
    <div class="header_inner">
        ...
        <div id="section">        
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#"><? print($cat); ?></a></li>
            
            </ul>
            
            <h1>Arab Laws | <? print($cat); ?></h1>
           
<?
//include("common.inc");
$catid = cleanQuery($catid);

if(is_numeric($catid)){

$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_cat = $catid AND law_publish = 'Y' ORDER BY law_id DESC";
...
{
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_cat = $catid AND law_publish = 'Y' ORDER BY law_id DESC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@arablawsworld.com");
}
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='middleeast-laws.php?catid=$catid&cat=$cat&page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
