...
<head>
    <title>UAE Federal Circulars | UAE Federal Circulars in English | UAE Federal Circulars Online | Translated UAE Federal Circulars</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="UAE Federal Circulars issued by the Governament of United Arab Emirates from 1971 to 2011. All Federal Circulars have been translated into English and available online for purchase on this page." />
	<meta name="keywords" content="uae federal circulars, uae federal circulars in english, uae federal circulars online, translated uae federal circulars" />
...
<div id="header">
    <div class="header_inner">
		<a href="./index.php" title="Back to home" class="logo">UAE Federal Circulars</a>
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/banner_consulting.jpg" width="980" height="218" alt="UAE Federal Circulars" title = "UAE Federal Circulars" />
            </div>        
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">UAE Federal Circulars</a></li>
            
            </ul>
            
            <h1>UAE Federal Circulars</h1>
           <p>
           UAE Federal Circulars issued by the Federal Governament of United Arab Emirates from 1971 to 2011. All Federal Circulars have been translated into English and available online for purchase on this page. you may order online and get a instant download link from us.  </p>


<?
//include("common.inc");
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE 'UAE, Circular%' OR law_title LIKE 'UAE Circular%' ORDER BY law_id DESC";
...
{
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE 'UAE, Circular%' OR law_title LIKE 'UAE Circular%' ORDER BY law_id DESC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@arablawsworld.com");
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='uae-federal-circulars.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
