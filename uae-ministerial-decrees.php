...
<head>
    <title>UAE Ministerial Decrees | UAE Ministerial Decrees in English | UAE Ministerial Decrees Online</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="UAE Ministerial Decrees issued by the Governament of United Arab Emirates from 1971 to 2011. All Ministerial Decrees have been translated into English and available online for purchase on this page." />
	<meta name="keywords" content="uae Ministerial Decrees, uae Ministerial Decrees in english, uae Ministerial Decrees online, translated uae Ministerial Decrees, uae Ministerial Decrees" />
...
<div id="header">
    <div class="header_inner">
		<a href="./index.php" title="Back to home" class="logo">UAE Ministerial Decrees</a>
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/banner_consulting.jpg" width="980" height="218" alt="UAE Ministerial Decrees" title = "UAE Ministerial Decrees" />
            </div>        
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">UAE Ministerial Decrees</a></li>
            
            </ul>
            
            <h1>UAE Ministerial Decrees</h1>
           <p>
           UAE Ministerial Decrees issued by the Governament of United Arab Emirates from 1971 to 2011. All Ministerial Decrees have been translated into English and available online for purchase on this page. you may order online and get a instant download link from us.  </p>


<?
//include("common.inc");
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE% Ministerial Decree%' AND law_publish = 'Y' ORDER BY law_id ASC";
...
{
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE% Ministerial Decree%' AND law_publish = 'Y' ORDER BY law_id ASC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@arablawsworld.com");
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='uae-ministerial-decrees.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
