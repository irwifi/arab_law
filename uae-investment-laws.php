...
<head>
    <title>UAE Investment Laws | UAE Investment Laws in English | UAE Investment Laws Online</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="Laws Regarding the Regulation of Financial Investment Companies, Banking, Financial and Investment Consultant Establishments and Companies in the United Arab Emirates" />
	<meta name="keywords" content="uae investment laws, uae investment laws in english, uae investment laws online, translated investment laws" />
...
<div id="header">
    <div class="header_inner">
		<a href="./index.php" title="Back to home" class="logo">UAE Investment Laws</a>
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/banner_consulting.jpg" width="980" height="218" alt="UAE Investment Laws" title = "UAE Investment Laws" />
            </div>        
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">UAE Investment Laws</a></li>
            
            </ul>
            
            <h1>UAE Investment Laws</h1>
           <p>
           UAE Investment Laws issued by the Governament of United Arab Emirates from 1971 to 2011. All Investment Laws have been translated into English and available online for purchase on this page. you may order online and get a instant download link from us.  </p>


<?
//include("common.inc");
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%Investment%' OR law_desc LIKE '%Investment%' ORDER BY law_title ASC";
...
{
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%Investment%' OR law_desc LIKE '%Investment%' ORDER BY law_title ASC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@arablawsworld.com");
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='uae-investment-laws.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
