...
<head>
    <title>UAE Constitutional Amendments | UAE Constitutional Amendments in English | UAE Constitutional Amendments Online</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="Laws concerning Constitutional Amendments in the United Arab Emirates" />
	<meta name="keywords" content="uae constitutional amendments, uae constitutional amendments in english, uae constitutional amendments online, translated constitutional amendments" />
...
<div id="header">
    <div class="header_inner">
		<a href="./index.php" title="Back to home" class="logo">UAE Constitutional Amendments</a>
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/banner_consulting.jpg" width="980" height="218" alt="UAE Constitutional Amendments" title = "UAE Constitutional Amendments" />
            </div>        
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">UAE Constitutional Amendments</a></li>
            
            </ul>
            
            <h1>UAE Utilities Laws</h1>
           <p>
           UAE Constitutional Amendments issued by the Governament of United Arab Emirates from 1971 to 2011. All UAE Constitutional Amendments have been translated into English and available online for purchase on this page. you may order online and get a instant download link from us.  </p>


<?
//include("common.inc");
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE% amendment%' OR law_desc LIKE '%UAE% amendment%' ORDER BY law_title ASC";
...
{
$query = "SELECT law_id, law_sku, law_desc, law_title, law_price, law_cat FROM en_laws WHERE law_title LIKE '%UAE% amendment%' OR law_desc LIKE '%UAE% amendment%' ORDER BY law_title ASC LIMIT $offset, $rec_per_page";
}
$result = mysql_query($query) or die("There is an error in database please contact support@arablawsworld.com");
...
?>            
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='uae-constitutional-amendments.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
