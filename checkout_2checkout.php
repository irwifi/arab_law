...
$result1 = mysql_query($query1) or die("There is an error in database please contact info@arablawsworld.com");
?>
...
<input type="hidden" name="merchant_order_id" value="<? print($cartid); ?>">
