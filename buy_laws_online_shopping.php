...
<head>
    <title>Middle East Laws | <? print($cat); ?> | <? print($law); ?></title>
...
<div id="header">
    <div class="header_inner">
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/banner_about.jpg" width="980" height="218" alt="Buy Laws Online" />
            </div>      
            ...
            <ul class="breadcrumb">
            	...
            	<li><a href="./index.php">Middle East Laws</a></li>
                
                <li>/</li>
                
                <li><a href="./middleeast-laws.php?catid=<? print($catid); ?>&cat=<? print($cat); ?>"><? print($cat); ?></a></li>
                
                <li>/</li>
                
                <li><a href="#"><? print($law); ?></a></li>
            
            </ul>
<?
$query = "SELECT * FROM en_laws WHERE law_id = $law_id";
$result = mysql_query($query) or die("There is an error in database please contact support@wonderd.ae");
$row=mysql_fetch_array($result);
?> 
            <h1><? print("$row[law_title]"); ?></h1>
           <p><? print("$row[law_desc]"); ?></p>
           <h2>US$ <? print round(("$row[law_price]")); ?>.00</h2>
           <table width="400" border="0">
             <tr>
               <td><a href="#" target="_self"><img src = "./images/buttons/CheckoutButton2COCards.jpg"></a></td>
               <td><a href="#" target="_self"><img src = "./images/buttons/paypal_checkout_button.png"></a></td>
             </tr>
           </table>
           <p>&nbsp;</p>
           <h2>Communication Legal Translation</h2>
           <p>Al Yasmeen Building. Office 209 Salah Uddin Street, Galadari InterChange, Deira 
           <br>Dubai - United Arab Emirates
           <br>P.O.Box: 22392
           <br>+971 4 2663517
           <br>comm123@emirates.net.ae
           </p>
           </div>   
