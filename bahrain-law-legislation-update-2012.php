...
<head>
    <title>Bahrain legislation update 2014</title>
    
    
<!-- META TAGS -->

	<meta name="description" content="During 2014 we have added number of bahrain legislations and laws updated including decrees, emiri decrees, royal decrees, resolutions and decisions." />
	<meta name="keywords" content="bahrain law update 2014, bahrain legislation update 2014, bahrain laws 2014, bahrain legislations 2014" />
...
<div id="header">
    <div class="header_inner">
        ...
        <div id="section">        
			...
			<img src="./images/pics_ah/bahrain-laws.jpg" width="980" height="218" alt="Bahrain Law Legislation Update 2012" title = "Bahrain Law Legislation Update 2012" />
            </div>        
            ...
            <h1>Bahrain Law Legislation Update 2014</h1>
			<p><a href = "./qatar-law-legislation-update-2012.php">Qatar Law Legislation Update 2012</a> | <strong>Bahrain Law Legislation Update 2012</strong> | <a href = "./uae-law-legislation-update-2012.php">UAE Law Legislation Update 2012</a></p>
            <p>We keep our online database of bahrain laws and legislations up-to-date, during 2014 we have added number of bahrain legislations and laws including decrees, emiri decrees, royal decrees, resolutions and decisions.</p> <p>However if you are not able to find your required legislation update of 2014 in our database, please let us know we will provide you translation on demand services and our team would be more than happy to assist you.</p>
           
<?
//include("common.inc");
$query = "SELECT law_id, law_title, law_desc, law_price, law_cat FROM en_laws WHERE law_publish = 'Y' AND law_clicks=2012 AND law_cat=58 ORDER BY law_id DESC";
...
{
$query = "SELECT law_id, law_title, law_desc, law_price, law_cat FROM en_laws WHERE law_publish = 'Y' AND law_clicks=2012 AND law_cat=58 ORDER BY law_id DESC LIMIT $offset, $rec_per_page";
}
...
?>
	...
	{ 
		if($i == $page_number) 
		 ...
		 {
			  print "&nbsp; <a href='bahrain-law-legislation-update-2012.php?page_number=$i'>$i</a>&nbsp; | "; 
		 }
	 }
?>
                </p>
